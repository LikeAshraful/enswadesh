...
class ShopPropertyDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $market = Market::updateOrCreate(['city_id' => $city->id, 'area_id' => $area->id, 'name' => 'Rajlokkhi', 'address' => 'Rajlokkhi, Uttra', 'description' => 'Rajlokkhi, Uttra', 'slug' => 'rajlokkhi', 'total_floor' => 8]);
        ...
        $market = Market::updateOrCreate(['city_id' => $city->id, 'area_id' => $area->id, 'name' => 'Basundhara City', 'address' => 'Panthopath, Dhaka', 'description' => 'Panthopath, Dhaka', 'slug' => 'basundhrar-city', 'total_floor' => 8]);
        ...
        $market = Market::updateOrCreate(['city_id' => $city->id, 'area_id' => $area->id, 'name' => 'RDA Market', 'address' => 'Zero Point, Rajshahi', 'description' => 'Zero Point, Rajshahi', 'slug' => 'rda-market', 'total_floor' => 8, 'icon' => null]);
        ...
        $market = Market::updateOrCreate(['city_id' => $city->id, 'area_id' => $area->id, 'name' => 'New Market', 'address' => 'Shahmukhdum, Rajshahi', 'description' => 'Shahmukhdum, Rajshahi', 'slug' => 'new-market', 'total_floor' => 8]);
