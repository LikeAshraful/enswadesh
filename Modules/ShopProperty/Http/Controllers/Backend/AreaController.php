...
class AreaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('shopproperty::Backend.area.index',  compact('areas'));
    }
    ...
    {
        $cities = City::all();
        return view('shopproperty::Backend.area.form', compact('cities'));
    }
    ...
    public function edit($id)
    {
        $cities = City::all();
        $area = area::find($id);
        return view('shopproperty::Backend.area.form', compact('area', 'cities'));
    }
